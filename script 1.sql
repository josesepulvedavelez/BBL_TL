...
CREATE TABLE Usuario (
    ...
    Rol NVARCHAR(20) NOT NULL CHECK (Rol IN ('Administrador', 'Coordinador', 'MiembroEquipo')),
...
CREATE TABLE Incidente (
    ...
    NivelSeveridad NVARCHAR(20) NOT NULL CHECK (NivelSeveridad IN ('Bajo', 'Medio', 'Alto', 'Crítico')),
    Estado NVARCHAR(20) NOT NULL CHECK (Estado IN ('Abierto', 'En Progreso', 'Resuelto', 'Cerrado')),
