...
CREATE TABLE TipoIncidente (
    TipoIncidenteId UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
    Nombre NVARCHAR(50) NOT NULL,
    Descripcion NVARCHAR(200) NULL
);

CREATE TABLE TipoEquipo (
    TipoEquipoId UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
    Nombre NVARCHAR(50) NOT NULL,
    Descripcion NVARCHAR(200) NULL
);

CREATE TABLE Equipo (
    EquipoId UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
    Nombre NVARCHAR(50) NOT NULL,
...
CREATE TABLE Incidente (
    IncidenteId UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
...
CREATE TABLE Recurso (
    RecursoId UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
